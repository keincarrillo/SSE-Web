              ...
              >
                {TESTIMONIALS.map((t, i) => (
                  ...
                  >
                    ...
                    >
                      <div
                        className="shrink-0 rounded-5 overflow-hidden border border-white/20 shadow-card-lg glass-card"
                        style={{
                      ...
                      >
                        ...
                        <Stars count={t.stars} />
                        <div
                          className="rounded-2xl border border-white/20 glass-card-subtle"
                          style={{
                            padding:
                        ...
                        >
                          <p
                            className="text-white font-bold leading-normal m-0 mb-3"
                    ...
                    >
                      <div
                        className="rounded-2xl overflow-hidden border border-white/20 shrink-0 mb-6 shadow-card glass-card"
                      ...
                      {t.subtitle && (
                        <h3 className="text-3xl font-bold text-white m-0 leading-[1.1] text-center">
                          {t.subtitle}
                        </h3>
                      )}
                      ...
                      <div
                        className="w-full rounded-3.5 border border-white/20 glass-card-subtle"
                        style={{ padding: '18px' }}
                      >
                        <p
                          className="text-white font-bold leading-normal m-0 mb-2.5"
                          style={{ fontSize: 'clamp(18px, 5.5vw, 22px)' }}
                        >
                          "{t.hook}"
                        </p>
                        <p
                          className="text-white/80 leading-[1.7] m-0 mb-2.5"
